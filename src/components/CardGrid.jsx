...
const Card = ({ image, category, project, description, route }) => {
  ...
  console.log(route,"show routing");
    return (
      
        <div className="bg-transparent rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 border-2 border-white p-4">
          ...
          <div className="p-4">
            ...
            {route && (
          <button onClick={() => navigate(route)}>Click</button>
        )}
          </div>
        </div>
