    ...
    <div className="container mx-auto px-4 py-8 text-white">
       <div className="bg-transparent text-center mb-16 relative">
                {/* Large background text */}
                    ...
                    <h3 class="text-3xl md:text-6xl font-semibold italic text-white mb-8 mt-8 lg:mb-24">Screen Visuals</h3>
                    <img src="../../public/images/WorkImg2.svg" alt="Web Design for Bomchi Cafe" className="w-full h-96 object-cover mb-10" />
                    <img src="../../public/images/WorkImg2.svg" alt="Web Design for Bomchi Cafe" className="w-full h-96 object-cover mb-10" />
